...
<input type='text' name='firstname' class="candidatebox" placeholder="First Name"><br>
<input type='text' name='surname' class="candidatebox" placeholder='Last Name'><br>
<input type='text' name='party' class="candidatebox" placeholder='Party'><br>
<input type='text' name='professional' class="candidatebox" placeholder='Profession'><br>
<input type='text' name='location' class="candidatebox" placeholder='Location'><br>
<input type='text' name='ika' class="candidatebox" placeholder='IKA'><br>
<input type='text' name='whyCommission' class="candidatebox2" placeholder='Why Commission'><br>
<input type='text' name='whatAthesWantEdes' class="candidatebox2" placeholder='more'><br>
...
<div class="radio-buttons">
    <input type="radio" Class="recommend-radio" name="${question.id}" value="0" style="visibility: hidden;" checked ><br>
...
<input  type="submit" class="question-button"  name="ok" value="Finish">
